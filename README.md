...
- **Output:** `outputs/matches_final.jsonl`
...
CAH Lab source datasets are assumed to be placed in folder cah_lab_v2_data_for_research_2025_06/, containing two files:
